...
<button class="nav-link active category-tab" id="eg-pills-1" data-bs-toggle="pill" data-bs-target="#eg-pills-one" type="button" role="tab" aria-controls="eg-pills-one" aria-selected="true">All Collection</button>
<button class="nav-link category-tab" id="eg-pills-2" data-bs-toggle="pill" data-bs-target="#eg-pills-two" type="button" role="tab" aria-controls="eg-pills-two" aria-selected="false">Mens Collcetion</button>
<button class="nav-link category-tab" id="eg-pills-3" data-bs-toggle="pill" data-bs-target="#eg-pills-three" type="button" role="tab" aria-controls="eg-pills-three" aria-selected="false">Women Collection</button>
<button class="nav-link category-tab" id="eg-pills-4" data-bs-toggle="pill" data-bs-target="#eg-pills-four" type="button" role="tab" aria-controls="eg-pills-four" aria-selected="false">Kids Collection</button>
<button class="nav-link category-tab" id="eg-pills-5" data-bs-toggle="pill" data-bs-target="#eg-pills-five" type="button" role="tab" aria-controls="eg-pills-five" aria-selected="false">Winter Collection</button>
<button class="nav-link category-tab" id="eg-pills-6" data-bs-toggle="pill" data-bs-target="#eg-pills-six" type="button" role="tab" aria-controls="eg-pills-six" aria-selected="false">Summer Collection</button>
</div>
</div>
...
<div class="tab-pane fade eg-product-tab-pane" id="eg-pills-four" role="tabpanel" aria-labelledby="eg-pills-4">
<div class="row">
<div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6 ">
<div class="product-card-m d-flex align-items-center">
<div class="product-img-m">
...
<div class="tab-pane fade eg-product-tab-pane" id="eg-pills-five" role="tabpanel" aria-labelledby="eg-pills-5">
<div class="row">
<div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6 ">
<div class="product-card-m d-flex align-items-center">
<div class="product-img-m">
...
<div class="tab-pane fade eg-product-tab-pane" id="eg-pills-six" role="tabpanel" aria-labelledby="eg-pills-6">
<div class="row">
<div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6 ">
<div class="product-card-m d-flex align-items-center">
<div class="product-img-m">
...
<a href="product-details.html"><img src="assets/images/product/pxl-1.png" alt class="img-fluid"></a>
...
<div class="product-card-xl">
<div class="product-img-xl">
<a href="product-details.html"><img src="assets/images/product/pxl-2.png" alt class="img-fluid"></a>
<div class="product-actions-xl">
<a href="#"><i class="flaticon-heart"></i></a>
<a href="product-details.html"><i class="flaticon-search"></i></a>
<a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
...
<div class="product-card-xl">
<div class="product-img-xl">
<a href="product-details.html"><img src="assets/images/product/pxl-3.png" alt class="img-fluid"></a>
<div class="product-actions-xl">
<a href="#"><i class="flaticon-heart"></i></a>
<a href="product-details.html"><i class="flaticon-search"></i></a>
<a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
...
<div class="product-card-xl">
<div class="product-img-xl">
<a href="product-details.html"><img src="assets/images/product/pxl-4.png" alt class="img-fluid"></a>
<div class="product-actions-xl">
<a href="#"><i class="flaticon-heart"></i></a>
<a href="product-details.html"><i class="flaticon-search"></i></a>
<a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
...
<div class="product-card-xl">
<div class="product-img-xl">
<a href="product-details.html"><img src="assets/images/product/pxl-7.png" alt class="img-fluid"></a>
<div class="product-actions-xl">
<a href="#"><i class="flaticon-heart"></i></a>
<a href="product-details.html"><i class="flaticon-search"></i></a>
<a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
...
<div class="product-card-xl">
<div class="product-img-xl">
<a href="product-details.html"><img src="assets/images/product/pxl-6.png" alt class="img-fluid"></a>
<div class="product-actions-xl">
<a href="#"><i class="flaticon-heart"></i></a>
<a href="product-details.html"><i class="flaticon-search"></i></a>
<a href="cart.html"><i class="flaticon-shopping-cart"></i></a>
...
<div class="row">
<div class="col-xxl-3 col-xl-3 col-lg-4">
<div class="nav flex-column nav-pills category-tabs" id="v-pills-tab" role="tablist" aria-orientation="vertical">
<button class="nav-link active category-tab" id="eg-pills-11" data-bs-toggle="pill" data-bs-target="#eg-pills-one1" type="button" role="tab" aria-controls="eg-pills-one1" aria-selected="true">All Collection</button>
<button class="nav-link category-tab" id="eg-pills-22" data-bs-toggle="pill" data-bs-target="#eg-pills-two2" type="button" role="tab" aria-controls="eg-pills-two2" aria-selected="false">Mens Collcetion</button>
<button class="nav-link category-tab" id="eg-pills-33" data-bs-toggle="pill" data-bs-target="#eg-pills-three3" type="button" role="tab" aria-controls="eg-pills-three3" aria-selected="false">Women Collection</button>
<button class="nav-link category-tab" id="eg-pills-44" data-bs-toggle="pill" data-bs-target="#eg-pills-four4" type="button" role="tab" aria-controls="eg-pills-four4" aria-selected="false">Kids Collection</button>
<button class="nav-link category-tab" id="eg-pills-55" data-bs-toggle="pill" data-bs-target="#eg-pills-five5" type="button" role="tab" aria-controls="eg-pills-five5" aria-selected="false">Winter Collection</button>
<button class="nav-link category-tab" id="eg-pills-66" data-bs-toggle="pill" data-bs-target="#eg-pills-six6" type="button" role="tab" aria-controls="eg-pills-six6" aria-selected="false">Summer Collection</button>
</div>
</div>
<div class="col-xxl-9 col-xl-9 col-lg-8">
<div class="tab-content eg-tab-content" id="v-pills-tabContent">
<div class="tab-pane fade show active eg-product-tab-pane" id="eg-pills-one1" role="tabpanel" aria-labelledby="eg-pills-11">
<div class="row">
...
<h3 class="product-title"><a href="product-details.html">Kids Renta Summer Sale</a></h3>
<div class="product-price">
<del class="old-price">$302.74</del><ins class="new-price">$290.05</ins>
</div>
</div>
...
<div class="tab-pane fade eg-product-tab-pane" id="eg-pills-two2" role="tabpanel" aria-labelledby="eg-pills-22">
<div class="row">
<div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
<div class="product-card-l">
<div class="product-img">
...
<div class="tab-pane fade eg-product-tab-pane" id="eg-pills-three3" role="tabpanel" aria-labelledby="eg-pills-33">
<div class="row">
<div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
<div class="product-card-l">
<div class="product-img">
...
<div class="tab-pane fade eg-product-tab-pane" id="eg-pills-four4" role="tabpanel" aria-labelledby="eg-pills-44">
<div class="row">
<div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
<div class="product-card-l">
<div class="product-img">
...
<div class="tab-pane fade eg-product-tab-pane" id="eg-pills-five5" role="tabpanel" aria-labelledby="eg-pills-55">
<div class="row">
<div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
<div class="product-card-l">
<div class="product-img">
...
<div class="tab-pane fade eg-product-tab-pane" id="eg-pills-six6" role="tabpanel" aria-labelledby="eg-pills-66">
<div class="row">
<div class="col-xxl-3 xol-xl-3 col-lg-4 col-md-4 col-sm-6">
<div class="product-card-l">
<div class="product-img">
...
<a href="blog-details.html">View This Story <i class="flaticon-arrow-pointing-to-right"></i></a>
</div>
</div>
</div>
</div>
...
<div class="blog-bottom">
<h4 class="blog-title"><a href="blog-details.html">The Coolest Fashion People to Follow in Every Age Group</a></h4>
<div class="blog-link-btn">
<a href="blog-details.html">View This Story <i class="flaticon-arrow-pointing-to-right"></i></a>
</div>
</div>
...
<div class="blog-bottom">
<h4 class="blog-title"><a href="blog-details.html">Let us know your thoughts in this is comments below</a></h4>
<div class="blog-link-btn">
<a href="blog-details.html">View This Story <i class="flaticon-arrow-pointing-to-right"></i></a>
</div>
</div>
...
<div class="blog-bottom">
<h4 class="blog-title"><a href="blog-details.html">How to come up with a good name for your fashion blog?</a></h4>
<div class="blog-link-btn">
<a href="blog-details.html">View This Story <i class="flaticon-arrow-pointing-to-right"></i></a>
</div>
</div>
